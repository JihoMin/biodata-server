...
dataset<- read_excel("C:/Users/SUNWOO/Desktop/Work_Place/R/easy_r/DB_Histogram_final.xlsx")
dataset[dataset==99999]<-NA 
data_p1 <- read_excel("C:/Users/SUNWOO/Desktop/BioDataLab/histogram_ahn.xlsx")
